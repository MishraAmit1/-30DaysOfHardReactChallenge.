...
1. [What is React?](#what-is-react)
   ...
   - [Example to Understand React](#example-to-understand-react)
   - [What is SPA (Single-Page Application)?](#what-is-spa-single-page-application)
     - [Normal Website vs SPA](#normal-website-vs-spa)
     - [How Does SPA Work?](#how-does-spa-work)
     - [Real-Life Examples of SPA](#real-life-examples-of-spa)
...
2. [What is JSX?](#what-is-jsx)
   ...
   - [Style and className in JSX](#style-and-classname-in-jsx)
     ...
     - [Using a Style Object](#using-a-style-object)
     - [Using className for CSS Classes](#using-classname-for-css-classes)
